                ...
                <div id="content-wrapper" class="d-flex flex-column">
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                      <div class="card-body">
                       <form enctype="multipart/form-data" action="./process/edit-regisuser.php" method="POST">
                        <div class="row">
                          <div class="col-md-7">
                            <div class="form-group">
                              <input type="hidden" name="id_user" value="<?php echo $id_user; ?>">
                              <label class="bmd-label-floating">Nama</label>
                              <input type="text" class="form-control" name="nama_lengkap" id="nama_lengkap" required="required" value="<?php echo $data['nama_lengkap']; ?>">
                            </div>
                          </div>
                          ...
                          <div class="col-md-5">
                            <div class="form-group">
                              ...
                              <input type="password" class="form-control" name="password" id="password" required="required" value="<?php echo $data['password']; ?>" readonly>
                            </div>
                          </div>
                        </div>
                              ...
                              <select class="form-control" id="level" name="level" >
                                ...
                                if(mysqli_num_rows($res) > 0){
                                  while($row = mysqli_fetch_assoc($res)){
                                    ...
                                    if ($id == $data['level']){
                                      ?>
                                      <option selected="true" value="<?= $id ?>"> <?= $level_name ?> </option>
                                      <?php
                                    } else {
                                      ?>
                        ...
                        <a href="datauser.php" class="btn btn-outline-info">Kembali</a>
