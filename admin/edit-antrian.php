                ...
                <div id="content-wrapper" class="d-flex flex-column">
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                      <h1 class="h3 mb-0 text-gray-800">Edit Status Pasien</h1>
                    </div>
                    ...
                    $query = "SELECT * FROM antrian WHERE id_antrian='$id_antrian'";
                    ...
                    <div class="card shadow mb-4">
                      <div class="card-body">
                       <form enctype="multipart/form-data" action="./process/edit-antrian.php" method="POST">
                        <div class="row">
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="hidden" name="id_antrian" value="<?php echo  $data['id_antrian']; ?>">
                          ...
                          <div class="col-md-10">
                            <div class="form-group">
                              ...
                              $dataAntrian = mysqli_fetch_assoc($result);
                              ?>
                              <input type="text" class="form-control" name="id_pasien" id="id_pasien" value="<?php echo $dataAntrian['nama']; ?>">
                        ...
                        <a href="antrian-today.php" class="btn btn-outline-info">Kembali</a>
